...
import { SolanaEventManager } from "../target/types/solana_event_manager";
...
describe("solana-event-manager", () => {
  // Configure the client to use the local cluster.
  anchor.setProvider(anchor.AnchorProvider.env());

  const program = anchor.workspace.SolanaEventManager as Program<SolanaEventManager>;
